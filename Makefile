...
runtime-v2-h2-tripwire-check:
	...
	SURGE_GATE_NAME=runtime-v2-h2-tripwire-check SURGE_BACKEND=llvm SURGE_SKIP_TIMEOUT_TESTS=0 bash scripts/runtime_v2_carrier_sanitizer_check.sh run --expect TestH2TripwireAwaitRunnerBuilds,TestH2TripwireDroppedCallBuilds,TestH2TripwireRefusedG5ModuleTimeout,TestH2TripwireImportAddsCoreRowsG5b,TestH2TripwireImportDifferentialRejectsTheTwin,TestH2TripwireTaskCheckRefusesLeaks,TestH2TripwireTaskCheckRefusesSpawnLeaks,TestH2TripwireSpawnRunnerBuilds -- $(GO) test ./internal/driver -run '^(TestH2TripwireAwaitRunnerBuilds|TestH2TripwireDroppedCallBuilds|TestH2TripwireRefusedG5ModuleTimeout|TestH2TripwireImportAddsCoreRowsG5b|TestH2TripwireImportDifferentialRejectsTheTwin|TestH2TripwireTaskCheckRefusesLeaks|TestH2TripwireTaskCheckRefusesSpawnLeaks|TestH2TripwireSpawnRunnerBuilds)$$' -short=false -count=1 -parallel=1 -p=1 -v --timeout 300s
	SURGE_GATE_NAME=runtime-v2-h2-tripwire-check SURGE_BACKEND=vm SURGE_SKIP_TIMEOUT_TESTS=0 bash scripts/runtime_v2_carrier_sanitizer_check.sh run --expect TestH2TripwireNotRunnableG1OwnBinding,TestH2TripwireNotRunnableG1bOwnExpr,TestH2TripwireNotRunnableG3ScopeJoin,TestH2TripwireNotRunnableG4xAsyncEntry,TestH2TripwireNotRunnableRo6xAsyncEntry,TestH2TripwireNotRunnableRo7xAsyncEntry,TestH2TripwireWitnessControl,TestH2TripwireHarnessObservesExit,TestH2TripwireMatcherRejectsRecordedFaults,TestH2TripwireTaskCheckRefusesLeakedRuns,TestH2TripwireAwaitRunnerRuns,TestH2TripwireDroppedCallNeverRuns,TestRuntimeV2BorrowedLocalTaskJoinedInItsFrame,TestH2TripwireTaskCheckRefusesSpawnLeakedRuns,TestH2TripwireSpawnRunnerRuns -- $(GO) test ./internal/vm -run '^(TestH2TripwireNotRunnableG1OwnBinding|TestH2TripwireNotRunnableG1bOwnExpr|TestH2TripwireNotRunnableG3ScopeJoin|TestH2TripwireNotRunnableG4xAsyncEntry|TestH2TripwireNotRunnableRo6xAsyncEntry|TestH2TripwireNotRunnableRo7xAsyncEntry|TestH2TripwireWitnessControl|TestH2TripwireHarnessObservesExit|TestH2TripwireMatcherRejectsRecordedFaults|TestH2TripwireTaskCheckRefusesLeakedRuns|TestH2TripwireAwaitRunnerRuns|TestH2TripwireDroppedCallNeverRuns|TestRuntimeV2BorrowedLocalTaskJoinedInItsFrame|TestH2TripwireTaskCheckRefusesSpawnLeakedRuns|TestH2TripwireSpawnRunnerRuns)$$' -short=false -count=1 -parallel=1 -p=1 -v --timeout 600s
	SURGE_GATE_NAME=runtime-v2-h2-tripwire-check SURGE_BACKEND=llvm SURGE_SKIP_TIMEOUT_TESTS=0 bash scripts/runtime_v2_carrier_sanitizer_check.sh run --expect TestH2TripwireNotRunnableG1OwnBinding,TestH2TripwireNotRunnableG1bOwnExpr,TestH2TripwireNotRunnableG3ScopeJoin,TestH2TripwireNotRunnableG4xAsyncEntry,TestH2TripwireNotRunnableRo6xAsyncEntry,TestH2TripwireNotRunnableRo7xAsyncEntry,TestH2TripwireWitnessControl,TestH2TripwireHarnessObservesExit,TestH2TripwireMatcherRejectsRecordedFaults,TestH2TripwireTaskCheckRefusesLeakedRuns,TestH2TripwireAwaitRunnerRuns,TestH2TripwireDroppedCallNeverRuns,TestRuntimeV2BorrowedLocalTaskJoinedInItsFrame,TestH2TripwireTaskCheckRefusesSpawnLeakedRuns,TestH2TripwireSpawnRunnerRuns -- $(GO) test ./internal/vm -run '^(TestH2TripwireNotRunnableG1OwnBinding|TestH2TripwireNotRunnableG1bOwnExpr|TestH2TripwireNotRunnableG3ScopeJoin|TestH2TripwireNotRunnableG4xAsyncEntry|TestH2TripwireNotRunnableRo6xAsyncEntry|TestH2TripwireNotRunnableRo7xAsyncEntry|TestH2TripwireWitnessControl|TestH2TripwireHarnessObservesExit|TestH2TripwireMatcherRejectsRecordedFaults|TestH2TripwireTaskCheckRefusesLeakedRuns|TestH2TripwireAwaitRunnerRuns|TestH2TripwireDroppedCallNeverRuns|TestRuntimeV2BorrowedLocalTaskJoinedInItsFrame|TestH2TripwireTaskCheckRefusesSpawnLeakedRuns|TestH2TripwireSpawnRunnerRuns)$$' -short=false -count=1 -parallel=1 -p=1 -v --timeout 900s
