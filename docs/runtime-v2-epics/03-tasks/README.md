...
| 7 | `07-owner-local-waiter-skeleton-tests.md` | Complete | test writing |
| 8 | `08-owner-local-waiter-skeleton.md` | Complete | runtime code |
| 9 | `09-channel-waiter-tests.md` | Complete | test writing |
| 10 | `10-channel-waiter-migration.md` | Complete | runtime code |
| 11 | `11-task-scope-blocking-waiter-tests.md` | Complete | test writing |
...
| 19 | `19-epic-closeout-and-static-gates.md` | Complete | closeout |
