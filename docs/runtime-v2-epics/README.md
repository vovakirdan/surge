...
| 21 | `21-owner-routed-frees.md` | **Core vertical complete; acceptance closeout open.** The owner-routed reclamation path shipped, while the unperformed Task 9 bench/matrix/seam/debt closeout and remaining tails are tracked by RV2-DEBT-125. |
