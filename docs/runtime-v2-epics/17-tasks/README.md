...
| 4 | `04-sema-lowering-e2e.md` | Complete (commits 940f4d7b, 9b3eee52) | compiler + gates | 1, 2 |
| 5 | `05-stabilization-closeout.md` | Complete | seam record + bench + debt + closeout | all |
