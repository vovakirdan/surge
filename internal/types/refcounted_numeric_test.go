...
func TestRefCountedNumericScalarKindsAndQualifiers(t *testing.T) {
	...
	rows := make([]numericRow, 0, 18)
	rows = append(rows,
		numericRow{"int", b.Int, true, true}, numericRow{"uint", b.Uint, true, true}, numericRow{"float", b.Float, true, true},
		numericRow{"int64", b.Int64, false, false}, numericRow{"uint64", b.Uint64, false, false},
		numericRow{"float64", b.Float64, false, false}, numericRow{"bool", b.Bool, false, false},
	)
