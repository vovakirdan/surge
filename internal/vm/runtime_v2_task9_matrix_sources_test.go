...
// The programs of the Epic 21 Task 9 matrix (runtime_v2_task9_matrix_e2e_test.go):
// one per cell that no existing row already carries, each a complete
// Surge program with its own completion marker.
