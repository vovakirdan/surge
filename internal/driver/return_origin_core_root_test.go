...
// N-CORE-ROOT: core is diagnosed AS core by giving the driver the real core file
...
// array concatenations (`prev + one`), which keep the N-CONCAT-USE row: pinned here.
