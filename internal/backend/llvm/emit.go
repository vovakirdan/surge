...
func EmitModule(mod *mir.Module, typesIn *types.Interner, symTable *symbols.Table, files *source.FileSet) (string, error) {
	...
	e.ensureStringConst("byte array append start out of range")
	e.ensureStringConst("byte array append length out of range")
	e.ensureStringConst("byte array drop prefix count out of range")
	...
	e.ensureStringConst("seek offset out of range")
	e.ensureStringConst("seek whence out of range")
	...
	e.ensureStringConst("net write offset out of range")
