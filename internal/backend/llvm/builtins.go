...
func runtimeDecls() []builtinDecl {
	...
	decls := []builtinDecl{
		...
		{name: "rt_task_clone", ret: "ptr", params: []string{"ptr", "ptr", "i64"}},
		...
		{name: "rt_immediate_on_execute", ret: "i32", params: []string{"i64", "i64", "i64", "ptr", "ptr", "ptr", "ptr"}},
		{name: "rt_immediate_on_execute_anchored", ret: "i32", params: []string{"ptr", "i64", "i64", "ptr", "ptr", "ptr", "ptr"}},
		{name: "rt_anchored_channel_send", ret: "void", params: []string{"i64"}},
		...
		{name: "rt_channel_new", ret: "ptr", params: []string{"i64", "i64"}},
