...
func runtimeDecls() []builtinDecl {
	...
	decls := []builtinDecl{
		...
		{name: "rt_blocking_submit", ret: "ptr", params: []string{"i64", "ptr", "i64", "i64", "i64"}},
		...
		{name: "rt_far_channel_create", ret: "i32", params: []string{"i64", "i64", "i64", "ptr", "ptr", "ptr", "ptr"}},
		...
		{name: "rt_map_new", ret: "ptr", params: []string{"i64"}},
		{name: "rt_map_len", ret: "i64", params: []string{"ptr"}},
		{name: "rt_map_contains", ret: "i1", params: []string{"ptr", "i64"}},
		{name: "rt_map_get_ref", ret: "i1", params: []string{"ptr", "i64", "ptr"}},
		{name: "rt_map_get_mut", ret: "i1", params: []string{"ptr", "i64", "ptr"}},
		{name: "rt_map_insert", ret: "i1", params: []string{"ptr", "i64", "i64", "ptr"}},
		{name: "rt_map_remove", ret: "i1", params: []string{"ptr", "i64", "ptr"}},
		{name: "rt_map_keys", ret: "ptr", params: []string{"ptr", "i64", "i64"}},
