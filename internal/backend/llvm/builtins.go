...
func runtimeDecls() []builtinDecl {
	return []builtinDecl{
		...
		{name: "rt_immediate_on_execute", ret: "i32", params: []string{"i64", "i64", "ptr", "ptr", "ptr", "ptr"}},
		{name: "rt_immediate_on_execute_anchored", ret: "i32", params: []string{"ptr", "i64", "ptr", "ptr", "ptr", "ptr"}},
		...
		{name: "rt_far_channel_select", ret: "i32", params: []string{"ptr", "ptr", "ptr", "i64", "i64", "ptr", "ptr", "ptr", "ptr"}},
