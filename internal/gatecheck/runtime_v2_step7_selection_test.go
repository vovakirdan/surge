...
func step7GateRows() []step7GateRow {
	...
	tripwireCompile := []string{
		...
		"TestH2TripwireTaskCheckRefusesSelectLeaks",
		"TestH2TripwireSelectRunnerBuilds",
		"TestTaskCheckCrossingBodyIsAFrame",
		"TestTaskCheckCrossingBodyKeepsSoundPrograms",
		"TestH2TripwireTaskCheckRefusesSpawnOnLeaks",
		"TestH2TripwireSpawnOnRunnerBuilds",
		"TestTaskCheckSpawnOnBodyEdges",
		"TestTaskCheckCrossingBodyPanicClosedFrame",
	}
	tripwireRuntime := []string{
		...
		"TestH2TripwireTaskCheckRefusesSelectLeakedRuns",
		"TestH2TripwireSelectRunnerRuns",
		"TestRuntimeV2CrossingBodyTaskOverItsCopy",
		"TestH2TripwireTaskCheckRefusesSpawnOnLeakedRuns",
		"TestH2TripwireSpawnOnRunnerRuns",
		"TestH2TripwireSpawnOnBodySuspensionHangs",
		"TestRuntimeV2SpawnOn",
	}
	...
	return []step7GateRow{
		...
		{"panic_vm", "runtime-v2-panic-surface-check", "./internal/vm", "runtime_v2_pending", "vm", []string{"TestVMNumericCastFailureContract", "TestRuntimeV2EntrypointArgvFailurePaths", "TestDefaultOfARuntimeHandleIsTheNullHandle", "TestAnUnmarkedLookalikeIsNotANullHandle", "TestNullRuntimeHandleIsInertOnEveryLifetimePath", "TestNullRuntimeHandleIsRefusedWithTheNativeWords", "TestNullRangeIsRefusedByEveryVMReader", "TestALiveRangeIsReadPastTheNullCheck"}},
		{"panic_llvm", "runtime-v2-panic-surface-check", "./internal/vm", "runtime_v2_pending", "llvm", []string{"TestVMNumericCastFailureContract", "TestRuntimeV2EntrypointArgvFailurePaths", "TestRuntimeV2DefaultRuntimeHandleIsNullOnBothBackends", "TestRuntimeV2NullRangeIsRefusedByEveryNativeEntryPoint"}},
