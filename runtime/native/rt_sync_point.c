...
static const char* rt_sp_name(rt_sync_point_id id) {
    switch (id) {
        ...
        case RT_SYNC_POINT_SP_CARRIER_PUBLISH_BEFORE_CREDIT:
            return "SP_CARRIER_PUBLISH_BEFORE_CREDIT";
        case RT_SYNC_POINT_SP_WORKER_BEFORE_CREDIT_WAIT:
            return "SP_WORKER_BEFORE_CREDIT_WAIT";
